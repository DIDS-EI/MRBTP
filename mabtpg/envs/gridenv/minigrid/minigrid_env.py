...
import re
import itertools
from mabtpg.envs.gridenv.minigrid.magrid_env import MiniGridMAGridEnv
from mabtpg.envs.gridenv.minigrid.magrid import MiniGridMAGrid
...
class MiniGridToMAGridEnv(MiniGridMAGridEnv):
    def __init__(
        self,
    ...
    def _gen_grid(self, width, height):
        ...
        self.grid.render = lambda *args,**kwargs: MiniGridMAGrid.render(self.grid,*args,**kwargs)
        # self.grid = MAGridEnv()
